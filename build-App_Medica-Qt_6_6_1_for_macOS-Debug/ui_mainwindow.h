...
"font: 700 11pt \"Segoe UI\";"));
        ...
        paciente_cb->setGeometry(QRect(110, 120, 181, 31));
...
"font: 700 11pt \"Segoe UI\";"));
        ...
        pushButton_80->setGeometry(QRect(390, 430, 111, 41));
        crearUser = new QCheckBox(AgregarRoll);
        crearUser->setObjectName("crearUser");
        crearUser->setGeometry(QRect(240, 210, 171, 31));
        label_118 = new QLabel(AgregarRoll);
        label_118->setObjectName("label_118");
        label_118->setGeometry(QRect(240, 190, 391, 16));
        crearExpedientes = new QCheckBox(AgregarRoll);
        crearExpedientes->setObjectName("crearExpedientes");
        crearExpedientes->setGeometry(QRect(240, 240, 151, 20));
        crearSalas = new QCheckBox(AgregarRoll);
        crearSalas->setObjectName("crearSalas");
        crearSalas->setGeometry(QRect(240, 260, 231, 20));
        editSala = new QCheckBox(AgregarRoll);
        editSala->setObjectName("editSala");
        editSala->setGeometry(QRect(240, 280, 131, 20));
        DesaSala = new QCheckBox(AgregarRoll);
        DesaSala->setObjectName("DesaSala");
        DesaSala->setGeometry(QRect(240, 300, 201, 20));
        EditExpe = new QCheckBox(AgregarRoll);
        EditExpe->setObjectName("EditExpe");
        EditExpe->setGeometry(QRect(240, 320, 181, 20));
        convencional = new QCheckBox(AgregarRoll);
        convencional->setObjectName("convencional");
        convencional->setGeometry(QRect(240, 340, 181, 20));
        crearReceta = new QCheckBox(AgregarRoll);
        crearReceta->setObjectName("crearReceta");
        crearReceta->setGeometry(QRect(240, 360, 131, 20));
        editReceta = new QCheckBox(AgregarRoll);
        editReceta->setObjectName("editReceta");
        editReceta->setGeometry(QRect(240, 380, 171, 20));
        AgeCita = new QCheckBox(AgregarRoll);
        AgeCita->setObjectName("AgeCita");
        AgeCita->setGeometry(QRect(240, 400, 181, 20));
        VerRepo = new QCheckBox(AgregarRoll);
        VerRepo->setObjectName("VerRepo");
        VerRepo->setGeometry(QRect(450, 210, 141, 20));
        VerReservas = new QCheckBox(AgregarRoll);
        VerReservas->setObjectName("VerReservas");
        VerReservas->setGeometry(QRect(450, 230, 191, 20));
        verCitas = new QCheckBox(AgregarRoll);
        verCitas->setObjectName("verCitas");
        verCitas->setGeometry(QRect(450, 250, 85, 20));
